...
define([
    ...
    Localization.initialize = function() {
                           ...
                           //checkdeepl settings
                             Localization.deeplSettings(
                                    ...
                                    if(responseDeepl.status=="false"){
                                      ...
                                      divDeepl.prepend("<div class='alert alert-danger' id='alertClose'>  <a href='#'' class='close'  data-dismiss='alert' aria-label='close'>&times;</a>"+ Localization.labels.deeplSettingsFailure +"</div>");
         ...
         * @return {Promise}
         */
        Localization.loadAvailableLanguages = function(pageId, colPos, languageId, mode) {
            return $.ajax({
